...
| Admin\ProjectController | index, forceArchive | API-035 / 034 |
...
| UploadFileRequest | API-025 | file required/max:10240(KB)/mimes+mimetypes（BR-FIL-001の許可種別を拡張子・MIME両面で） |
